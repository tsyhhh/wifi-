      ...
      async ResetSeries(){
        ...
        Play()  {
          anime
            ...
            .add({ targets: ".hand.left", rotate: [180, 0] }, 0) //左手晃动幅度
            .add({ targets: ".hand.right", rotate: [-20, -20] }, 0) //右手晃动幅度
            .add({ targets: ".leg .left", rotate: [6,6] }, 0) //左脚晃动幅度
            .add({ targets: ".leg .right", rotate: [-6,-6] }, 0); //右脚晃动幅度
        },
    ...
    .body {
      ...
      .hand {
        ...
        &::after {
          ...
          bottom: 10px;
          transform-origin: 50% 100%;
          transform: rotate(180deg); //手臂弯曲幅度
        }
      }.left{
               left: calc(50% - 30px);
             }
